...
利用包括气候数据和土壤中铀含量测量在内的县级预测指标W，表征j县地质特征的指标$ \delta_k(j) $为K = 19类型之一。最后，根据数据估算了19种地质类型的$ δ_k $系数，$$ \delta_k \widetilde{} N(0,\kappa^2), &emsp; for &emsp; geologic &emsp; type k = 1,...,K, $$
